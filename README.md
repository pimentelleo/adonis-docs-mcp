...
## Using with Agentfish

Instead of copying these instructions manually, we strongly recommend using [Agentfish](https://github.com/pimentelleo/agentfish) to automatically install the exact rules, guidelines, and context required for an AdonisJS v7 project directly into your codebase.

```bash
uvx agentfish add pimentelleo/adonisjs7-agent
```

This will automatically create the necessary `.cursorrules`, `CLAUDE.md`, or `.github/copilot-instructions.md` files configured to use this MCP server.
