...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Use list_versions to see available versions, list_sections to browse "
...
def _get_client() -> httpx.AsyncClient:
    return httpx.AsyncClient(
        headers={"User-Agent": "adonis-docs-mcp/0.1.0"},
...
async def search_docs(query: str, version: str = "v7") -> str:
    ...
    versions_to_search = (
        list(VERSIONS.keys()) if version.lower().strip() == "all"
